...
printf("To test numbers of the form k*2^n-1 press 1. To test numbers of the form k*2^n+1 press 2 : ");
scanf("%d",&opt);
...
{
f=1;
printf("That combination of the coefficient and exponent isn't supported by this test!\n");
}
...
{
f=1;
printf("Exponent must be greater than 2 !\n");
}
